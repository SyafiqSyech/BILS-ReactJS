      ...
      <div className='flex h-min'>
        ...
        >
          <motion.div variants={boxState} className='flex justify-center py-3 px-6 text-center border-2 rounded-full'>
            <motion.p variants={textState} className='txt1 z-[2] select-none'>{props.text}</motion.p>
            <motion.span variants={arrowState} className="material-symbols-sharp text-[18px] mt-[-1px] z-[2] select-none">arrow_back</motion.span>
          </motion.div>
