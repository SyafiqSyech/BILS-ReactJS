      ...
      <div aria-hidden className='p-4 flex justify-center items-center relative min-h-[100svh]'>
        ...
        >
          ...
          <div className='flex flex-wrap gap-x-8 max-md:gap-x-4 gap-y-16 max-sm:gap-y-8 justify-center'>
            <Outlet image={'Carousel3.jpg'} name={'Cibis9'} desc={'Jl. Raya Cilandak KKO No.13 - Cilandak Timur - Pasar Minggu - Jakarta Selatan'} onClick={ () => window.open(cibis[props.link]) }/>
            <Outlet image={'Carousel2.jpg'} name={'Kemang'} desc={'Jl. Benda Raya No.8a - Cilandak Timur - Pasar Minggu - Jakarta Selatan'} onClick={ () => window.open(kemang[props.link]) }/>
