...
const Locations = () => {
  return (
    <>
      <p className='txt2 w-full text-center pb-16 max-lg:pb-8'>Locations</p>
      <div className='flex flex-wrap gap-x-8 max-md:gap-x-4 gap-y-8 justify-center px-16 max-md:px-8' id='locations'>
        <LocationCard 
          image={ 'Cibis2.jpg' } 
          name={ 'Cibis 9' } 
        ...
        {/* <LocationCard 
          ...
          mapsClick={ () => window.open('https://maps.app.goo.gl/pw7AoNWmzR8qjbFy8?g_st=ic')}
        /> */}
        <div className='w-[30rem] max-lg:w-[24rem] max-md:w-full max-w-[32rem] h-96 flex flex-col justify-center items-center p-8 rounded-[3rem] border-2 bg-gray-200'>
          <p className='txt1 text-center'>More Coming Soon</p>
          <p className='text-center pt-2'>InsyaAllah</p>
        </div>
      </div>
    </>
  )
